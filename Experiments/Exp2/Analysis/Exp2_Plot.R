...
# ggplot2::ggsave("Experiments/Exp2/Figures/Figure_1a.pdf", width = 5.7, height = 6.4, units = "in")
# ggplot2::ggsave("Experiments/Exp2/Figures/Figure_1a.png", width = 5.7, height = 6.4, units = "in")
#
...
# ggplot2::ggsave("Experiments/Exp2/Figures/Figure_1b.pdf", width = 5.7, height = 6.4, units = "in")
# ggplot2::ggsave("Experiments/Exp2/Figures/Figure_1b.png", width = 5.7, height = 6.4, units = "in")
#
# Export the figure directly using "Export" option: 570 x 640
