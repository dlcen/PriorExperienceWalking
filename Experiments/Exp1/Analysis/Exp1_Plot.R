...
ggplot2::ggsave("Experiments/Exp1/Figures/Figure_1.png", width = 24, height = 10, units = "cm")
...
ggplot2::ggsave("Experiments/Exp1/Figures/Figure_1_trajectories.pdf", width = 12, height = 10, units = "cm")
